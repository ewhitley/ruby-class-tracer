...
bob = Simpsons::Characters::SimpsonsCharacter.new("Bob", "Terwilliger")
...
thouse = Simpsons::Characters::SimpsonsCharacter.new("Thrilhou", nil)
thouseArStr = thouse.do_something_with_items(arInt)

hotdog = Simpsons::KWIKEMartProduct.new("Hot Dog", 1.0)
hotdog.increase_cost(3)
hotdog.increase_cost
monitored = hotdog.monitored_by_magic_hat?

elbarto = Simpsons::Characters::BartNames.new("Bart")
...
#puts class_tracer.namespace_list
